      ...
      <Layout>
          ...
          <Form method="post">
            <BlockStack align="space-around" gap="400">
              ...
              {discountMethod.value === DiscountMethod.Code && (
                <UsageLimitsCard
                  totalUsageLimit={usageLimit as unknown as Field<null>}
              ...
              />
              <ActiveDatesCard
                startDate={startDate as unknown as Field<string>}
                endDate={endDate as unknown as Field<string>}
        ...
        <Layout.Section>
          <SummaryCard
            ...
            activeDates={{
              startDate: startDate.value as unknown as string,
